startingimage = 'd:\p\speed.jpg'
backgroundimage = 'd:\p\ppt.jpg'
essay = 'd:\p\essay.txt'
icon = 'd:\p\icon.png'
...
class Test:
    ...
    def __init__(self):
        self.color_heading = (15,202,237)
        self.color_text = (12,182,236)
        self.color_results = (237,15,227)
        self.w=750
        self.h=500
        self.reset=True
        self.wpm = 0
        ...
        self.bg = pygame.transform.scale(self.bg, (800,1050))
    ...
    def results_show(self, screen):
        if(not self.end):
            ...
            self.draw_text(screen,"Reset", self.h - 70, 26, (15,16,237))
